...
IF EXISTS (SELECT name  FROM master.sys.server_principals WHERE name = 'I2B2_DB_SHRINE_ONT_USER')
	BEGIN
		DROP LOGIN [I2B2_DB_SHRINE_ONT_USER]
		DROP USER [I2B2_DB_SHRINE_ONT_USER]
	END
