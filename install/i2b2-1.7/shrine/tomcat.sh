...
# @see skel/shrine.xml          = webapp context
# @see skel/steward.xml         = steward context
...
#####
echo "[shrine/tomcat.sh] Downloading and configuring shrine steward"
...
interpolate "SHRINE_DB_NAME" "$SHRINE_DB_NAME" > $SHRINE_TOMCAT_APP_CONF

#####
echo "[shrine/tomcat.sh] Configuring steward.xml"
