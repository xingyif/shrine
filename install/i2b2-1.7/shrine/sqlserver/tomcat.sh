...
require "${SHRINE_DB_USER}" "SHRINE_DB_USER must be set"
require "${SHRINE_DB_PASSWORD}" "SHRINE_DB_PASSWORD must be set"
require "${SHRINE_DB_HOST}" "SHRINE_DB_HOST must be set"
