 ...
 */
trait AuthStrategy {
  def determineAuthenticator(authType: AuthenticationType, pmPoster: Poster): Authenticator
...
object AuthStrategy {
  object Default extends AuthStrategy {
    import AuthenticationType._
    import AuthorizationType._
    
    override def determineAuthenticator(authType: AuthenticationType, pmPoster: Poster): Authenticator = authType match {
    ...
    override def determineQueryAuthorizationService(authType: AuthorizationType, shrineConfig: ShrineConfig, authenticator: Authenticator): QueryAuthorizationService = {
      authType match {
