...
create table "problems" ("id" INTEGER NOT NULL PRIMARY KEY,"codec" VARCHAR(254) NOT NULL,"stampText" VARCHAR(254) NOT NULL,"summary" VARCHAR(254) NOT NULL,"description" VARCHAR(254) NOT NULL,"detailsXml" VARCHAR(254) NOT NULL,"epoch" NUMBER(19) NOT NULL);
