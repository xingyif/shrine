System.register(['aurelia-framework', 'aurelia-event-aggregator', 'common/queries.model', './scroll.service', 'common/shrine.messages'], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
            _export('QueryViewer', QueryViewer = (_dec = inject(EventAggregator, QueriesModel, notifications, commands), _dec(_class = function QueryViewer(evtAgg, queries, notifications, commands) {
                var _this = this;
